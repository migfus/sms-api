...
class UserSeeder extends Seeder
{
  public function run(): void {
    $data = [
      [
        ...
        'mid_name' => '[mid]',
        'ext_name' => 'Jr',
        'civil_status_id' => \App\Models\CivilStatus::find(1)->first()->id, // single
        'birth_day' => Carbon::now(),
        'birth_place_id' => DB::table('address_cities')->where('id', 258)->first()->id, // valencia city, bukidnon
        'blood_type_id' => \App\Models\BloodType::find(1)->first()->id, // O+
        'sex' => 1,
        'height' => 1.6,
        'weight' => 65.1,
  ...
  private function CreateExperience($personID): void {
    $data = [
      [
        ...
        'from' => '2018-10-28',
        'to' => null,
        'work_status_id' => \App\Models\WorkStatus::find(1)->first()->id, // Job Order
        'salary' => 11000,
        'salary_type_id' => 2,
      ...
      [
        ...
        'from' => '2018-06-01',
        'to' => '2018-10-27',
        'work_status_id' => \App\Models\WorkStatus::find(5)->first()->id, // On Call
        'salary' => 5000,
        'salary_type_id' => 3,
        // [1] hourly, [2] daily, [3] monthly
        'is_government' => 1,
  ...
  private function CreateEducation($personID): void {
    $data = [
      [
        'person_id' => $personID,
        'level' => \App\Models\EducationLevel::where('id', 1)->first()->id, // primary
      ...
      [
        'person_id' => $personID,
        'level' => \App\Models\EducationLevel::where('id', 2)->first()->id, // secondary
      ...
      [
        'person_id' => $personID,
        'level' => \App\Models\EducationLevel::where('id', 4)->first()->id, // tertiary
  ...
  private function CreateSeminar($personID): void {
    $data = [
      [
        ...
        'to' => '2022-02-02',
        'hours' => 2,
        'seminar_type_id' => \App\Models\SeminarType::find(1)->first()->id, // managerial
        'sponsor' => 'SponsorMan',
      ]
    ];

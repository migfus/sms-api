...
const subNavigation = [
  { name: 'Personal Info', href: '#', icon: UserCircleIcon, current: true },
  { name: 'Education', href: '#', icon: AcademicCapIcon, current: false },
  { name: 'Eligibilities', href: '#', icon: CheckBadgeIcon, current: false },
  { name: 'Experience', href: '#', icon: BriefcaseIcon, current: false },
  { name: 'Voluntaries', href: '#', icon: HandThumbUpIcon, current: false },
  { name: 'Seminars', href: '#', icon: PresentationChartLineIcon, current: false },
  { name: 'Skills', href: '#', icon: ScaleIcon, current: false },
  { name: 'Mobile Numbers', href: '#', icon: DevicePhoneMobileIcon, current: false },
]
